...
function Home() {
  ...
  useEffect(() => {
    ...
    const fetchTodos = async () => {
      try {
        ...
        // console.log(response); //response contains the entire things and all details that can be seen by using  inspect in the console page
  ...
  const navigateTo = useNavigate(); // we can use const navigateTo = useNavigate(); and navigateTo("/login") for navigation or instead we can use Directly naviagte tag i.e <Navigaate to={"/login"}/>
